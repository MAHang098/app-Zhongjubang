	...
	<view id="allOrder">
		...
		<view class="header">
			<view class="header-top">
				<image @click.stop="backPage" src="../../../static/img/G-circle/search-back.png" mode="" class="back"></image>
				<view class="my-order">我的订单</view>
				<view>
					<image src="../../../static/search/nav-search.png" mode="" class="search"></image>
					<image src="../../../static/img/shopping-mall/order/cart.png" mode="" class="cart" @click.stop="goCart"></image>
				</view>
			</view>
			<!-- 订单类型 start -->
